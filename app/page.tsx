    ...
    <div className="min-h-[500px] py-32" aria-hidden="true">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-xs mb-16">
          <div className="h-4 w-24 mx-auto rounded bg-white/[0.04] animate-pulse mb-4" />
          <div className="h-8 w-64 mx-auto rounded bg-white/[0.04] animate-pulse mb-3" />
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="rounded-2xl border border-white/[0.04] bg-white/[0.02] p-8">
              <div className="h-10 w-10 rounded-xl bg-white/[0.04] animate-pulse mb-4" />
              <div className="h-5 w-32 rounded bg-white/[0.04] animate-pulse mb-3" />
